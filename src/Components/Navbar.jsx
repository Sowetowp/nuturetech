        ...
        <>
            <header className='myHeader' style={{display:"flex", alignItems:"center", justifyContent:"space-between"}}>
                ...
                <div style={{width:"50%", display:"flex", alignItems:"center", justifyContent:"end", gap:"10px"}}>
                    ...
                    <a href="" style={{fontSize:"12px", fontWeight:"600", color:"white", backgroundColor:"#005B00", paddingTop:"5px", paddingBottom:"5px", paddingLeft:"12px", paddingRight:"12px", textDecoration:"none", borderRadius:"10px"}}>Post a Job</a>
                </div>
            </header>
        </>
    )
