        ...
        <>
            <header className='myHeader' style={{display:"flex", alignItems:"center", justifyContent:"space-between"}}>
                ...
                <div style={{width:"50%", display:"flex", alignItems:"center", justifyContent:"end"}}>
                    ...
                    <a href="" style={{fontSize:"12px", fontWeight:"600", color:"white", backgroundColor:"#005B00", paddingTop:"7px", paddingBottom:"7px", paddingLeft:"12px", paddingRight:"12px"}}>Post a Job</a>
                </div>
            </header>
        </>
    )
