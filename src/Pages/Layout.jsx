                ...
                <div className="wrapper">
                    <div className="sidebar">
                        <div className="cir1">
                            <nav>
                                <ul>
                                    <li><a href="" style={{ color: "green" }}>Biography</a></li>
                    ...
                    <div className="main-page">
                        <div>
                            <div className="blogo11">
                                <div className="blogo2">
                                    ...
                                    <div>
                                        ...
                                        <p className="buka">Bukalapak . jakarta, Indonesia</p>
                                    </div>
                                </div>
                                <div className="buka1">
                                    <img src={time} alt="" style={{ width: "20px", height: "20px" }} />
                            ...
                            <div className="writeup">
                                <p>The visual Designer convey design concept into wireframes and high fidelity, quality prototypes that<br />
                                    match project requirement product objective brand personality or brand language of travel
                                </p>
                            </div>
                        </div>
                    </div>
